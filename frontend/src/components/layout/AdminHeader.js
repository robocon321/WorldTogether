  ...
  return (
    ...
    <div className="d-flex justify-content-between">
      <div className="left d-flex align-items-center">
        <div className="title-nav me-4 d-flex align-items-center" id="toggle-nav"><span className="me-2 h-10 d-flex align-items-center"><img className="h-full" src="/assets/images/nav.png" alt="Not found" /></span><span>{props.title}</span></div>
      ...
      <div className="right d-flex align-items-center">
        ...
        <div className="acc-info">
          <div className="acc-avatar me-3"><img src="/assets/images/account-black.png" alt="" /></div>
        </div>
        <div className="acc">
