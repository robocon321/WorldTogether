...
const ShopNew = props => {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    let result = await createShop(shop);
    if(result.success) {
      alert.current.style.display = "none";
                  ...
                  <div ref={alert} className="alert alert-danger">
                    ...
                    <table>
                      <tbody>
                        <tr>
                          <td>Tên shop</td>
                          <td colSpan="3"><input type="text" name="title" onChange={onChangeField} required /></td>
                        </tr>
                        <tr>
                          <td>Mô tả</td>
                          <td colSpan="3"><input type="text" name="descrp" onChange={onChangeField} required /></td>
                        </tr>
                        <tr>
                          <td>Từ khóa SEO</td>
                        ...
                        <tr>
                          <td>Avatar</td>
                          <td><input type="file" name="avatar" accept="image/png, image/jpeg" onChange={onChangeField} required /></td>
                        </tr>
                        <tr>
                          <td colSpan="3"></td>
                          <td>
